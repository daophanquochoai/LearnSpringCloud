...
@RestController
public class CurrencyConsersionController {
    @Autowired
    private CurrencyExchangeProxy currencyExchangeProxy;
//    @GetMapping("/currency-converter/from/{from}/to/{to}/quantity/{quantity}")
//    public CurrencyConversionBean conversionBean(
//            @PathVariable String from,
//            @PathVariable String to,
//            @PathVariable BigDecimal quantity
//        ){
//        CurrencyConversionBean responseEntity= currencyExchangeProxy.retrieveExchangeValue(from, to);
//        CurrencyConversionBean currencyConversionBean = responseEntity;
...
//    }
    ...
    public CurrencyConversionBean conversionBeanFeign(
            @PathVariable String from,
            @PathVariable String to,
            @PathVariable BigDecimal quantity
    ){
